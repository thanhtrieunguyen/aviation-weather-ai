...
const Flight = require("../models/Flight"); // Điều chỉnh đường dẫn nếu cần
...
async function runMigration() {
    try {
        // Cập nhật các chuyến bay chưa có trường 'Initial_price' hoặc 'Current_price'
                ...
                $set: {
                    ...
                    Current_price: {
                        $cond: {
                            ...
                            then: { $ifNull: ["$Initial_price", 1000000] },
                            else: "$Current_price"
                        }
                    }
                }
