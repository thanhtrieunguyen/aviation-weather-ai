  ...
  return (
    <View style={styles.bottomNav}>
      ...
      <TouchableOpacity
        ...
        onPress={() => handleNavigation('PilotDashboard')}
      >
      ...
      >
        ...
        <Text style={styles.bottomNavText}>Lịch sử đặt vé</Text>
      </TouchableOpacity>

      {/* Đặt vé */}
      <TouchableOpacity
        style={styles.bottomNavItem}
        onPress={() => handleNavigation('FlightRoute')}
      >
        <Ionicons name="ticket-outline" size={24} color="#4A90E2" />
        <Text style={styles.bottomNavText}>Đặt vé</Text>
      </TouchableOpacity>
